...
$(document).ready(function () {
  ...
  $("#pokemon-select, #pokemon-input").change(function () {
    ...
    $.get(pokemonUrl, function (data) {
      ...
      //types
      pokemonInfo += "<tr class= 'is-fullwidth'><th class='has-text-white'>Types:</th><td>";
  ...
  // debug the types
  //pokemonInfo += "<tr class= 'is-fullwidth'><th class='has-text-white'>Debug test:</th><td class= has-text-white> [Pokemon types list: " + types  + "] <br> [trackType: "+ trackType + "] <br> [typeClass: "+ typeClass + "] </td>";

   //Weaknesses and Immunities
   //pokemonInfo += "<tr class= 'is-fullwidth'><th class='has-text-white'>Weakness:</th><td class= has-text-white>";
   ...
   // Check if the Pokemon have 2 types
      ...
      //Abilities
      pokemonInfo +=
        "<tr class= 'is-fullwidth'><th class='has-text-white'>Abilities:</th><td>";
